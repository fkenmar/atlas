...
1. Run /bench.
2. Run /milestone.
3. Summarize what changed since the last review: `git log --oneline` since the previous weekly-review commit (or the last 7 days if none), grouped by pipeline stage — one line per theme, not per commit.
