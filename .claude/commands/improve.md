...
5. Measure only what the change affects. Agent-behavior changes → `./benchmark/run.sh`, compare vs baseline.json and the latest benchmark/history.md row. Respect the $15/session benchmark spend guard.
